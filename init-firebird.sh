...
#         localhost:/firebird/data/${FIREBIRD_DATABASE:-nfautopecas.fdb} \
...
echo ""
echo "📊 Resumo:"
echo "  • Banco de dados: ${FIREBIRD_DATABASE:-nfautopecas.fdb}"
...
echo "  Database: /firebird/data/${FIREBIRD_DATABASE:-nfautopecas.fdb}"
